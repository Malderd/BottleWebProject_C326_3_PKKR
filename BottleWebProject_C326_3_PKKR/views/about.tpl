        ...
        <div class="cards">
            <div class="card">
                ...
                <p class="contribution">
                    Дизайн страницы для поиска Эйлерова цикла/цепи, реализация алгоритма и создание UML-диаграмм проекта, <br>логотипа сайта.
                </p>
    ...
    <div class="contacts-block">
        ...
        <div class="contacts-grid">
            <div class="contact-column">
                <h4>GitHub</h4>
                <a href="https://github.com/Malderd/BottleWebProject_C326_3_PKKR" target="_blank">
                    Репозиторий проекта
                </a>
            </div>
